...
class FileTransferStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendFile = channel.unary_unary(
                ...
                request_serializer=filetransfer__pb2.FileRequest.SerializeToString,
                response_deserializer=filetransfer__pb2.FileResponse.FromString,
                _registered_method=True)
        self.ReceiveFile = channel.unary_unary(
                '/filetransfer.FileTransfer/ReceiveFile',
                request_serializer=filetransfer__pb2.FileRequest.SerializeToString,
                response_deserializer=filetransfer__pb2.FileResponse.FromString,
                _registered_method=True)
...
def add_FileTransferServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendFile': grpc.unary_unary_rpc_method_handler(
                    servicer.SendFile,
                    request_deserializer=filetransfer__pb2.FileRequest.FromString,
...
class FileTransfer(object):
    ...
    def SendFile(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/filetransfer.FileTransfer/SendFile',
            filetransfer__pb2.FileRequest.SerializeToString,
